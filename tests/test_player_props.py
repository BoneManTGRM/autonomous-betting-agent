...
class PlayerPropTests(unittest.TestCase):
    ...
    def test_apply_and_rank_player_props(self) -> None:
        frame = pd.DataFrame([
            {"player_name": "A", "prop_type": "TD", "best_price": 2.20, "model_probability": "55%", "books": 8, "data_quality": 90},
            {"player_name": "B", "prop_type": "Goal", "best_price": 1.80, "model_probability": "50%", "books": 8, "data_quality": 90},
        ])
