...
TEXT = {
    ...
    "es": {
        ...
        "workspace": "Cliente / ID de espacio",
        "use_saved": "Usar filas guardadas/actuales del espacio",
        "upload": "Subir filas CSV",
        "source": "Fuente",
        "empty": "No se encontraron filas. Ejecuta Pro Predictor / Odds Lock Pro primero o sube un CSV.",
        ...
        "full_book_name": "Nombre del libro de revista",
        ...
        "proof": "Prueba analista",
        "exports": "Exportaciones",
        "images": "Imágenes",
        "profile_json": "JSON perfil",
        "feed_json": "Feed de app",
        "diagnostics": "Diagnósticos",
        "pdf": "Descargar PDF",
        "magazine_pdf": "Descargar PDF de revista",
        "magazine_png": "Descargar PNG de revista",
        "html": "Descargar HTML",
        "md": "Descargar Markdown",
        "json": "Descargar JSON",
        "csv": "Descargar CSV",
        "copy_download": "Descargar copy WhatsApp",
        "images_note": "Exportaciones de revista para el reporte completo y una página completa seleccionada.",
        "image_tab_info": "Construye el libro completo solo cuando lo necesites, o selecciona una pick para renderizar/descargar una página.",
        "background_upload": "Imagen de fondo opcional para la revista",
        "background_ready": "Fondo personalizado activo.",
        "background_preview": "Vista previa del fondo",
        "generated_preview": "Vista previa de revista generada",
        "feed_saved": "Feeds unificado y legacy guardados.",
        "copy_label": "Copy corto",
        "no_audit": "No hay datos de calibración calificados aún.",
        "build_book": "Crear libro completo de revista",
        "building_book": "Creando libro completo...",
        "download_book_png": "Descargar PNG del libro completo",
        "download_book_pdf": "Descargar PDF del libro completo",
        "download_zip": "Descargar ZIP completo",
        "download_page": "Descargar página completa",
        "select_page": "Selecciona una pick para renderizar",
        "publisher": "Publicador de prueba",
        "publisher_workspace_id": "ID de espacio del publicador",
        "package_type": "tipo_paquete",
        "build_publisher_payload": "Crear paquete publicador",
        "publisher_caption": "Paquetes ledger-backed son proof-grade solo cuando proof_ready=true. Provisional o vacío no es prueba final.",
        "publisher_preview_ready": "Vista publicador creada. Descargas usan este package_hash hasta que cambien entradas.",
        "stale_publisher": "El espacio/tipo de paquete actual no coincide con la vista guardada. Crea una vista nueva antes de descargar.",
        "redaction_failed": "Falló validación de redacción. Descargas públicas/cliente bloqueadas.",
        "headline_summary": "resumen_titular",
        "performance_summary": "resumen_rendimiento",
        "roi_summary": "resumen_roi",
        "clv_summary": "resumen_clv",
        "risk_summary": "resumen_riesgo",
        "top_positive_ev_summary": "resumen_top_ev_positivo",
    },
}
