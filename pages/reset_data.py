...
SESSION_KEYS = [
    ...
    'ultra80_profit_mode_rows',
    'ultra80_max_volume_rows',
    'ultra80_reserve_rows',
    'simulation_survivor_rows',
...
TEXT = {
    'en': {
        ...
        'session_help': 'Removes temporary rows from Scanner Pro, Pro Predictor, Ultra 80, Simulation Lab, What Are the Odds, Game Intelligence, Command Center, Odds Lock Pro, and handoff state. It does not delete downloaded CSV files.',
    ...
    'es': {
        ...
        'session_help': 'Quita filas temporales de Scanner Pro, Predictor Pro, Ultra 80, Laboratorio de Simulación, What Are the Odds, Game Intelligence, Command Center, Odds Lock Pro y handoff. No borra CSVs descargados.',
