...
def apply_volume_pattern_points(frame, *args, **kwargs):
    ...
    if 'decision_signals' in out.columns:
        out['decision_signals'] = out['decision_signals'].astype(str) + '; pattern_points_v1; profit_guard_v1'
    return out
