...
def _install_streamlit_helpers() -> None:
    ...
    notes_es = (
        "Flujo comercial: Scanner Pro → Predictor Pro → What Are the Odds → Odds Lock Pro → Dashboard Público de Prueba → Memoria de Aprendizaje.",
        ...
        "Usa Odds Lock Pro para crear filas de prueba con timestamp antes de conocer resultados.",
        "Usa Dashboard Público de Prueba para métricas seguras para clientes, cargas de resultados, ledger persistente y tarjetas de reporte.",
    ...
    es_columns = {
        ...
        "locked_at_utc": "hora_bloqueo_utc",
        "graded_at_utc": "hora_calificacion_utc",
        "proof_id": "id_prueba",
    ...
    es_values = {
        ...
        "unknown": "pendiente",
        "pending": "pendiente",
        "locked_before_start": "bloqueado_antes_del_inicio",
        "locked_without_verified_start": "bloqueado_sin_inicio_verificado",
        "invalid_after_start": "invalido_despues_del_inicio",
        "used": "usado",
    ...
    es_phrases = {
        ...
        "best price at": "mejor cuota en",
        "play small": "jugar pequeño",
        "play strong": "jugar fuerte",
