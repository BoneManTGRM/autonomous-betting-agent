...
COLUMN_LABELS_ES = {
    ...
    "agent_decision": "decisión_agente",
    ...
    "decision_reasons": "razones_decisión",
    "edge": "ventaja",
    ...
    "model_lean_label": "inclinación_modelo",
    ...
    "public_confidence": "confianza_pública",
    "public_pick": "selección_pública",
    "public_reason": "razón_pública",
    ...
    "research_lock_blockers": "bloqueos_investigación",
    "research_lock_ready": "listo_bloqueo_investigación",
    "result": "resultado",
    ...
    "voids": "voids",
    "why_it_matters": "por_qué_importa",
...
VALUE_LABELS_ES = {
    ...
    "c_research_volume": "Nivel C - volumen de investigación",
    "row_level": "nivel de fila",
    "event_level": "nivel de evento",
    "official": "oficial",
    "research": "investigación",
    "research_play": "jugada de investigación",
    "research_test": "investigación/prueba",
    "research_test_future_only": "investigación/prueba futuro",
    "client": "cliente",
    ...
    "research_test_lock": "bloqueo investigación/prueba",
    "accuracy_test_lock_value_blockers_ignored_not_an_official_ev_pick": "Bloqueo de prueba de precisión; bloqueos de valor ignorados. No es una jugada oficial +EV.",
}
